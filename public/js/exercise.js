...
async function handleFormSubmit(event) {
    ...
    // add an exercise (a PUT request to update workout document by updatingit's exercise array) using the newly created workoutData object)
